...
const translations = {
    en: {
        ...
        nickname_err_empty: 'NO EMPTY INPUT FIELD!',
        nickname_err_duplication: 'NICKNAME DUPLICATION NOT ALLOWED!',
        nickname_err_setfail: 'FAILED TO SET NICKNAMES!',
        nickname_err_fetchfail: 'ERROR OCCURRED WHILE SENDING NICKNAMES!',
    ...
    ko: {
        ...
        nickname_ready: '준비!',
        nickname_err_empty: '아직 입력하지 않은 칸이 남아있습니다!',
        nickname_err_duplication: '중복된 닉네임은 사용할수 없습니다!',
        nickname_err_setfail: '닉네임 설정에 실패했습니다!',
        nickname_err_fetchfail: '닉네밈 전송중 에러가 발생했습니다!',
    ...
    jp: {
        ...
        nickname_ready: 'レディー!',
        nickname_err_empty: 'まだ入力していないマスが残っています!',
        nickname_err_duplication: '重複したニックネームは使用できません!',
        nickname_err_setfail: 'ニックネームの設定に失敗しました!',
        nickname_err_fetchfail: 'ニックネームの転送中にエラーが発生しました!',
